-- =================================================================================================================
-- jbst — v001 baseline only; Liquibase applies db/changelog/changes v002+ at context startup
-- (fresh Testcontainers Postgres needs pgcrypto for gen_random_uuid used by v010)
-- =================================================================================================================
