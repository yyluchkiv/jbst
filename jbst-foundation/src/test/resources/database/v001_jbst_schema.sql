-- =================================================================================================================
-- jbst — KEEP IN SYNC with jbst-server-iam/src/main/resources/postgres/changes/v001_jbst_schema.sql
-- (fresh Testcontainers Postgres 11 needs pgcrypto for gen_random_uuid)
-- =================================================================================================================
...
CREATE TABLE "jbst_users_tokens" (
    ...
    -- nullable here (unlike the iam changelog): the foundation JbstPostgresUserToken entity does not map username
