...
class JbstMongoInvitationsServiceTest {
    ...
    static class ContextConfiguration {
        ...
        @Bean
        JbstMongoInvitationsService invitationsService() {
            return new JbstMongoInvitationsService(
    ...
    private final JbstMongoInvitationsService componentUnderTest;
