...
class JbstRejectedExecutionHandlerPublisherTest {
    ...
    static class ContextConfiguration {
        ...
        @Bean
        JbstRejectedExecutionHandlerPublisher rejectedExecutionHandlerPublisher() {
            return new JbstRejectedExecutionHandlerPublisher(
    ...
    private final JbstRejectedExecutionHandlerPublisher componentUnderTest;
