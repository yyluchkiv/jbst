...
class JbstErrorHandlerPublisherTest {
    ...
    static class ContextConfiguration {
        ...
        @Bean
        JbstErrorHandlerPublisher errorHandlerPublisher() {
            return new JbstErrorHandlerPublisher(
    ...
    private final JbstErrorHandlerPublisher componentUnderTest;
