...
class JbstIncidentTest {
    ...
    void copyOfTest() {
        ...
        // Act
        var copy = JbstIncident.copyOf(incident);
    ...
    void convertThrowableIncident1Test() {
        ...
        // Act
        var actual = new JbstIncident(throwable);
        ...
        assertThat(actual.getAttributes().get("trace").toString()).contains("at jbst.foundation.incidents.domain.JbstIncidentTest.convertThrowableIncident1Test");
    }
    ...
    void convertThrowableIncident2Test() {
        ...
        // Act
        var actual = new JbstIncident(throwable, method, params);
        ...
        assertThat(actual.getAttributes().get("trace").toString()).startsWith("java.lang.NullPointerException: jbst");
        assertThat(actual.getAttributes().get("trace").toString()).contains("at jbst.foundation.incidents.domain.JbstIncidentTest.convertThrowableIncident2Test");
    ...
    void convertThrowableIncident3Test() {
        ...
        // Act
        var actual = new JbstIncident(throwable, attributes);
        ...
        assertThat(actual.getAttributes().get("trace").toString()).startsWith("java.lang.NullPointerException: jbst");
        assertThat(actual.getAttributes().get("trace").toString()).contains("at jbst.foundation.incidents.domain.JbstIncidentTest.convertThrowableIncident3Test");
    }
}
