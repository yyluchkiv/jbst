...
public class JbstUsersTokensCronsTest {
    ...
    static class ContextConfiguration {
        ...
        @Bean
        JbstUsersTokensCrons sessionsCron() {
            return new JbstUsersTokensCrons(
    ...
    private final JbstUsersTokensCrons componentUnderTest;
