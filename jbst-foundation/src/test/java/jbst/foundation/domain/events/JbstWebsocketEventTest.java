...
class JbstWebsocketEventTest extends JbstUnitTests.Runners.BaseFolder {
    ...
    void serialize1Test() {
        // Arrange
        var websocketEvent = new JbstWebsocketEvent();
    ...
    void hardwareMonitoringTest() {
        var websocketEvent = JbstWebsocketEvent.hardwareMonitoring(
        ...
        assertThat(websocketEvent.getAttributes().get("datapoint").getClass()).isEqualTo(JbstHardwareMonitoringDatapointTableView.class);
    ...
    void resetServerProgressTest() {
        var websocketEvent = JbstWebsocketEvent.resetServerProgress(
