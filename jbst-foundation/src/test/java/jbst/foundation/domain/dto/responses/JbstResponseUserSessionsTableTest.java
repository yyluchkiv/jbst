...
class JbstResponseUserSessionsTableTest {

    @Test
    void noSessionsConstructorTest() {
        // Act
        var actual = JbstResponseUserSessionsTable.of(new ArrayList<>());
    ...
    void constructorTest() {
        ...
        var responseUserSession21 = JbstResponseUserSession2.of(
                JbstUserSessionId.random(),
                getCurrentTimestamp(),
                username,
                new JbstRequestAccessToken(randomString()),
        ...
        var responseUserSession22 = JbstResponseUserSession2.of(
                JbstUserSessionId.random(),
                getCurrentTimestamp(),
                username,
                new JbstRequestAccessToken("token2"),
        ...
        var responseUserSession23 = JbstResponseUserSession2.of(
                JbstUserSessionId.random(),
                getCurrentTimestamp(),
                username,
                new JbstRequestAccessToken(randomString()),
        ...
        // Act
        var actual = JbstResponseUserSessionsTable.of(new ArrayList<>(List.of(responseUserSession21, responseUserSession22, responseUserSession23)));
