...
public class JbstPropertyEvents extends JbstProperty {
    ...
    public static JbstPropertyEvents fixed() {
        return new JbstPropertyEvents(true, "jbst-events", new BigDecimal("75"), HUNDRED);
    }

    public static JbstPropertyEvents random() {
        return new JbstPropertyEvents(true, randomString(), new BigDecimal("25"), HUNDRED);
    }
    ...
    public TuplePercentage asThreadsCorePoolTuplePercentage() {
        assertNonNullOrThrow(this.threadsCorePoolPercentage, "events.threads-core-pool-percentage");
    ...
    public TuplePercentage asThreadsMaxPoolTuplePercentage() {
        assertNonNullOrThrow(this.threadsMaxPoolPercentage, "events.threads-max-pool-percentage");
