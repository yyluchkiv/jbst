...
public record JbstResponseUserSession2(
    ...
    public static final Comparator<JbstResponseUserSession2> USERS_SESSIONS = comparing(JbstResponseUserSession2::current).reversed()
            .thenComparing(JbstResponseUserSession2::where);

    public static final Comparator<JbstResponseUserSession2> ACTIVE_SESSIONS_AS_SUPERADMIN = comparing(JbstResponseUserSession2::current).reversed()
            .thenComparing((JbstResponseUserSession2 session) -> session.who().value())
            .thenComparing(JbstResponseUserSession2::where);

    public static final Comparator<JbstResponseUserSession2> INACTIVE_SESSIONS_AS_SUPERADMIN = comparing((JbstResponseUserSession2 session) -> session.who().value())
            .thenComparing(JbstResponseUserSession2::where);

    public static JbstResponseUserSession2 of(
            JbstUserSessionId id,
            long updatedAt,
            Username username,
        ...
        return new JbstResponseUserSession2(
                id,
                username,
                current,
                activity,
    ...
    public static JbstResponseUserSession2 random() {
        return of(
