...
public class JbstEnumsCreator {
    ...
    public static <E extends Enum<E> & JbstEnumValue<String>> E findEnumByValueIgnoreCaseOrThrow(Class<E> enumClass, String value) {
        Predicate<E> filter = e -> e.getValue().equalsIgnoreCase(value);
        return findEnumOrThrow(enumClass, value, filter);
    }

    public static <E extends Enum<E> & JbstEnumValue<String>> E findEnumByNameOrThrow(Class<E> enumClass, String name) {
    ...
    public static <E extends Enum<E> & JbstEnumValue<String>> E findEnumByValueOrUnknown(Class<E> enumClass, String value) {
        return findEnumOrUnknown(enumClass, string -> string.equals(value));
    }

    public static <E extends Enum<E> & JbstEnumValue<String>> E findEnumByValueIgnoreCaseOrUnknown(Class<E> enumClass, String value) {
        return findEnumOrUnknown(enumClass, string -> string.equalsIgnoreCase(value));
    }

    public static <E extends Enum<E> & JbstEnumValue<Integer>> E findEnumByValueOrUnknown(Class<E> enumClass, int value) {
    ...
    // PRIVATE METHODS
    // ================================================================================================================
    public static <E extends Enum<E> & JbstEnumValue<String>> E findEnumOrThrow(Class<E> enumClass, String param, Predicate<E> predicate) {
        return Arrays.stream(enumClass.getEnumConstants())
                .filter(predicate)
                .findFirst()
                .orElseThrow(() -> {
    ...
    private static <E extends Enum<E> & JbstEnumValue<V>, V> E findEnumOrUnknown(Class<E> enumClass, Predicate<V> predicate) {
        return Arrays.stream(enumClass.getEnumConstants())
