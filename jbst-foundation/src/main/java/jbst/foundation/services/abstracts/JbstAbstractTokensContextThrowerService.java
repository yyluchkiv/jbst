...
public abstract class JbstAbstractTokensContextThrowerService implements JbstTokensContextThrowerService {

    // Assistants
    protected final JbstUserDetailsService jwtUserDetailsService;
    // Repositories
