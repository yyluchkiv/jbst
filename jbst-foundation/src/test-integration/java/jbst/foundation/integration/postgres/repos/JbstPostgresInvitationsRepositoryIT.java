...
class JbstPostgresInvitationsRepositoryIT extends TestsJbstConfigurationPostgresRepositoriesRunner {

    private final JbstPostgresInvitationsRepository invitationsRepository;

    @Override
    public JpaRepository<JbstPostgresInvitation, String> getJpaRepository() {
    ...
    void readIntegrationTests() {
        // Arrange
        var saved = this.invitationsRepository.saveAll(JbstPostgresInvitation.dummies1());
    ...
    void findUnusedAndSortingTests() {
        // Arrange
        this.invitationsRepository.saveAll(JbstPostgresInvitation.dummies2());
