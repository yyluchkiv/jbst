...
class JbstMongoUsersTokensRepositoryIT extends TestsJbstConfigurationMongoRepositoriesRunner {

    private final JbstMongoUsersTokensRepository usersTokensRepository;
    ...
    void readIntegrationTests() {
        // Arrange
        var saved = this.usersTokensRepository.saveAll(JbstMongoUserToken.dummies1());
