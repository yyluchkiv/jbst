...
class JbstMongoUsersSessionsRepositoryIT extends TestsJbstConfigurationMongoRepositoriesRunner {

    private final JbstMongoUsersSessionsRepository usersSessionsRepository;

    @Override
    public MongoRepository<JbstMongoUserSession, String> getMongoRepository() {
    ...
    void readIntegrationTests() {
        // Arrange
        var saved = this.usersSessionsRepository.saveAll(JbstMongoUserSession.dummies1());
    ...
    void enableMetadataRenewCronTest() {
        // Arrange
        var saved1 = this.usersSessionsRepository.saveAll(JbstMongoUserSession.dummies1());
    ...
    void deleteByUsernameExceptAccessTokenTest() {
        // Arrange
        this.usersSessionsRepository.saveAll(JbstMongoUserSession.dummies2());
